...
outfileName = paste(sid, "size.vs.end.pdf", sep=".");
...
## long fragments
plot( -1000, xlim=c(-100, 100), ylim=c(0, max(longU$V2, longD$V2)),
...
## short fragments
plot( -1000, xlim=c(-100, 100), ylim=c(0, max(shortU$V2, shortD$V2)),
	 xlab="Relative position to nucleosome center (bp)", ylab="Normalized end density",
...
## pooled
plot( -1000, xlim=c(-100, 100), ylim=c(0, max(longU$V2, longD$V2, shortU$V2, shortD$V2)),
	 xlab="Relative position to nucleosome center (bp)", ylab="Normalized end density",
